      ...
      <div className="border rounded p-2 bg-white">
        {imageError ? (
          ...
          <img 
            ...
            className="w-48 h-48"
            onError={() => {
              console.error("QR code image failed to load. Switching to fallback service.");
              const fallbackUrl = `https://quickchart.io/qr?text=${encodeURIComponent(tableUrl)}&size=250`;
